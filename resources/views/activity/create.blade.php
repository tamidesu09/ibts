        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <a href="{{ route('activity.index') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form action="#" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('activity_url') is-invalid @enderror"
                                name="activity_url" value="{{ old('activity_url') }}" placeholder="Input URL (Optional)" />
                            @error('activity_url')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('attendees') is-invalid @enderror"
                                ...
                                placeholder="Seach candidate or email address" />
                            @error('attendees')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
