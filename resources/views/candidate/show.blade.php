                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div class="card-body">
                                            <p class="text-secondary">Add any relevant notes about the candidate here.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <select class="form-select me-2 @error('appstatus') is-invalid @enderror"
                                        name="appstatus">
                                        <option value="" disabled selected>Application Received</option>
                                        <option value="Application Received">Screen</option>
                                        <option value="Initial Screening">Under Review</option>
                                        <option value="Under Review">Interview Schedule</option>
                                        <option value="Interview Schedule">Offer</option>
                                    </select>
